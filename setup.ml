...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5f56d2ee530544671b6dd9957c0863e0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Siva Somayyajula"];
          homepage = None;
          bugreports = None;
          synopsis = "Equivalence modulo user specification in NetKAT";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "?:\183\0310/\003i\204\180&\222\030\225\148)";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
